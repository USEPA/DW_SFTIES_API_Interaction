# Note: This script calls the postgREST api for DW-SFTIES to get the all the water systems for your primacy agency. First you interact with the server to retrieve the access token and then use the access token to interact with the api
